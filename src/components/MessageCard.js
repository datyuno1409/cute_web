...
const messages = [
    "Gửi đến người con gái tuyệt vời nhất trong cuộc đời anh.",
    "Nụ cười của em luôn làm anh cảm thấy vui và hạnh phúc, và tình yêu của em lấp đầy trái tim anh bằng sự ấm áp.",
            ...
            >
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        >
                            {messages[currentMessage].text || messages[currentMessage]}
                        </Message>
                    </MessageWrapper>
                </AnimatePresence>
                ...
                <ButtonContainer>
                    <Button
                        ...
                        whileTap={{ scale: 0.95 }}
                    >
                        {messages[currentMessage].isFinish ? 'View Our Album' : 'Next Message'}
                        <HeartIcon
                            animate={{
                                scale: [1, 1.3, 1],
                                rotate: [0, 10, -10, 0]
